    ...
    return (
        <div className="employee-profile">
            ...
            <div className="employee-footer">
                <Button variant="contained" disabled={editing} onClick={() => { setEditing(true); onEditClick(employee,); }} sx={{ margin: '5px', backgroundColor: '#757575' }}>
                    Edit
                </Button>
                <Button variant="contained" disabled={editing} onClick={() => onDeleteClick(employee)} sx={{ margin: '5px', backgroundColor: '#757575' }}>
                    Delete
                </Button>
            </div>
        </div>
